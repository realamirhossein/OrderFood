...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('/orders/{order}/edit', 'AdminController@editOrder')->name('orders.edit');
    ...
    Route::get('/statuses/{status}/edit', 'AdminController@editStatus')->name('statuses.edit');
    ...
    Route::get('/menus/{menu}/edit', 'AdminController@editMenu')->name('menus.edit');
    ...
    Route::get('/foods/{food}/edit', 'AdminController@editFood')->name('foods.edit');
